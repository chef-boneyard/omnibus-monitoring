...
source :path => File.expand_path("files/opscode-monitoring-ctl-commands", Omnibus.root)
...
#{install_dir}/embedded/bin/omnibus-ctl opscode-monitoring #{install_dir}/embedded/service/omnibus-ctl $@
       EOH
    end
  end
